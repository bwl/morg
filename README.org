...
The simplest way is to download from [[https://emacsformacosx.com/][emacsformacosx.com]] - make sure to get the latest version (29+).

*** Alternative: Install via Homebrew (recommended)

Using Homebrew gives you the Emacs-mac port with better macOS integration:
...
- Better macOS integration (emoji, smooth scrolling, retina support)
- Native support for =org-protocol=
